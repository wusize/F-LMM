...
from src.datasets.hpt_processors import CustomHPT15ImageProcessor
from src.models.frozen_hpt import FrozenHPTSAM
...
model = dict(
    ...
    visual_encoder=dict(type=SiglipVisionModel.from_pretrained,
                        pretrained_model_name_or_path=hpt_name,
                        subfolder='visual_encoder',
                        torch_dtype=torch.bfloat16),
